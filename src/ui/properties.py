    ...
    def _rebuild_stops_list(self):
        ...
        for i, (pos, color) in enumerate(sorted(self.stops)):
            ...
            if len(self.stops) > 2:  # Keep at least 2 stops
                ...
                remove_btn.setToolTip("Remove gradient stop")
                remove_btn.setAccessibleName("Remove gradient stop")
...
from src.core.constants import DISPLAY_WIDTH, DISPLAY_HEIGHT, DATA_SOURCES_CATEGORIZED
...
class PropertiesPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        self.color_btn.setToolTip("Pick element color")
        self.color_btn.setAccessibleName("Pick element color")
        ...
        self.bg_color_btn.setToolTip("Pick background color")
        self.bg_color_btn.setAccessibleName("Pick background color")
        ...
        self.bar_border_color_btn.setToolTip("Choose border color")
        self.bar_border_color_btn.setAccessibleName("Choose border color")
        self.bar_border_color_btn.setStyleSheet("background-color: #ffffff;")
        self.bar_border_color_btn.setToolTip("Pick border color")
        self.bar_border_color_btn.setAccessibleName("Pick border color")
        ...
        self.bold_checkbox.setToolTip("Toggle bold font")
        self.bold_checkbox.setAccessibleName("Toggle bold font")
        self.bold_checkbox.setStyleSheet("font-weight: bold;")
        self.bold_checkbox.setToolTip("Bold")
        self.bold_checkbox.setAccessibleName("Bold")
        ...
        self.italic_checkbox.setToolTip("Toggle italic font")
        self.italic_checkbox.setAccessibleName("Toggle italic font")
        self.italic_checkbox.setStyleSheet("font-style: italic;")
        self.italic_checkbox.setToolTip("Italic")
        self.italic_checkbox.setAccessibleName("Italic")
        ...
        self.value_text_color_btn.setToolTip("Pick value text color")
        self.value_text_color_btn.setAccessibleName("Pick value text color")
        ...
        self.label_bold_checkbox.setToolTip("Toggle label bold font")
        self.label_bold_checkbox.setAccessibleName("Toggle label bold font")
        self.label_bold_checkbox.setStyleSheet("font-weight: bold;")
        self.label_bold_checkbox.setToolTip("Bold label")
        self.label_bold_checkbox.setAccessibleName("Bold label")
        ...
        self.label_italic_checkbox.setToolTip("Toggle label italic font")
        self.label_italic_checkbox.setAccessibleName("Toggle label italic font")
        self.label_italic_checkbox.setStyleSheet("font-style: italic;")
        self.label_italic_checkbox.setToolTip("Italic label")
        self.label_italic_checkbox.setAccessibleName("Italic label")
        ...
        self.label_text_color_btn.setToolTip("Pick label text color")
        self.label_text_color_btn.setAccessibleName("Pick label text color")
        ...
        self.image_browse_btn.setToolTip("Browse image")
        self.image_browse_btn.setAccessibleName("Browse image")
        ...
        self.gif_browse_btn.setToolTip("Browse GIF")
        self.gif_browse_btn.setAccessibleName("Browse GIF")
